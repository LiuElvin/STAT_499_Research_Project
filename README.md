...
In this project, we will first learn some classical supervised classification techniques and discuss the curse of dimensionality.
...
Finally, we will implement PDA to analyze a real-life dataset of the student’s choice and some simple toy examples.
