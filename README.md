...
I've also provided some example code if reproduction is of interest.
  ...
  - There are 2 class labels, class1 or class2, that the data is marked as.

  - There are 20 samples per class.

  - There are 40 columns (1 of which indicates whether the data point is class1 or class2).

  - 38 columns have completely arbitrary data generated by `rnorm()`

  - The first column is our "identifier" column, its data is added or subtracted by 2.2 depending on which class it is.
